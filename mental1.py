...
def main():
    ...
    .chat-container {
        ...
        gap: 20px;  /* Menambahkan jarak antar pesan */
        max-height: 500px;
        overflow-y: auto;
        padding: 10px;
    ...
    .user-message {
        ...
        margin-left: 20%;  /* Jarak dari kiri */
    ...
    .bot-message {
        ...
        margin-right: 20%;  /* Jarak dari kanan */
    ...
    if 'chat_history' not in st.session_state:
        ...
        st.session_state.user_name = None  # Menyimpan nama pengguna
    ...
    # Tanya nama pengguna jika belum ada
    if st.session_state.user_name is None:
        name_input = st.text_input("Siapa nama Anda?", key="user_name_input")
        
        # Tombol untuk mengonfirmasi nama
        if st.button("Kirim nama"):
            if name_input:
                ...
                st.experimental_rerun()  # Refresh halaman untuk menampilkan pesan salam
    else:
        # Input pengguna berada di bawah riwayat chat
        user_input = st.text_input("Perasaan Anda Saat Ini:", key="user_input")
        
        # Membuat kolom untuk tombol Kirim dan Reset
        col1, col2 = st.columns([1, 0.3])  # Atur proporsi kolom
        ...
        with col1:
            ...
            if st.button("Kirim"):
                if user_input:
                    ...
                    save_chat_history(st.session_state.chat_history)
                    st.experimental_rerun()  # Refresh halaman untuk menampilkan pesan baru
